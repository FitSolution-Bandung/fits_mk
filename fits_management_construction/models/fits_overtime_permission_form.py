...
# Model Formulir Izin Lembur / Overtime Form
class OvertimeForm(models.Model):
    _name = 'overtime.form'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = 'Overtime Form'
    ...
    overtime_ids = fields.One2many('overtime.form.detail', 'overtime_id', string="Overtime Form")
    ...
    def write(self, vals):
        ...
        return super(OvertimeForm, self).write(vals)
...
class OvertimeFormDetail(models.Model):
    _name = 'overtime.form.detail'
    _description = 'Overtime Form Detail'
    _rec_name = 'name_items'

    overtime_id     = fields.Many2one('overtime.form', string="Overtime Form")
    name_items      = fields.Char(string="Work Items")
    tools           = fields.Char(string="Tools")
    workers         = fields.Char(string="Number of Workers")
